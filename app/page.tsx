const page = () => {
  return (
    <section className='w-full flex-center flex-col max-w-screen-2xl mx-auto'>
      <div>
        <h1 className='scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl font-gloock'>
        ...
        <h3 className='font-sora mt-8 scroll-m-20 text-2xl font-semibold tracking-tight'>
          The Joke Tax
        </h3>
        <p className='leading-7 [&:not(:first-child)]:mt-6'>
        ...
        <p className='leading-7 [&:not(:first-child)]:mt-6'>
          ...
          was one person who refused to let the king's foolishness get him down: a court jester
          named Jokester.
        </p>
        <h3 className='font-sora mt-8 scroll-m-20 text-2xl font-semibold tracking-tight'>
          Jokester's Revolt
